...
from AuthenticationUsersApp.forms import RegisterUserForm #Para crear el formulario de creación y login de usuario
...
def register_user(request): #Página para registrar usuarios
    ...
    if request.method == 'POST':
        user_form = RegisterUserForm(request.POST) #Guardo la data
